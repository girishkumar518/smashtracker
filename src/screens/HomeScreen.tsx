...
export default function HomeScreen() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {/* 1. Modern Header */}
            {/* 1. New Context Header */}
            {/* 1. New Context Header (Control Panel Style) */}
            {/* 1. Header Thumbnail (Identity & Context) */}
            {/* 1. Header Thumbnail (Identity & Context) */}
            <View style={styles.headerThumbnail}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                    <TouchableOpacity onPress={() => navigation.navigate('Profile')} style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View style={{ marginLeft: 12 }}>
                            <Text style={{ fontSize: 13, color: theme.colors.textSecondary, fontWeight: '600', marginBottom: 2 }}>Welcome back,</Text>
                    ...
                    <View style={{ flexDirection: 'row', gap: 10 }}>
                        <TouchableOpacity style={styles.iconBtn} onPress={() => navigation.navigate('GlobalStats')}>
                ...
                {/* BOTTOM ROW: Club Context */}
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <TouchableOpacity
                        style={styles.clubSelectorRow}
                    ...
                    {activeClub && (
                        <TouchableOpacity
                            ...
                            style={{
                                width: 44, height: 44,
                                borderRadius: 14,
                                backgroundColor: theme.colors.primary + '10', // Matched Tint
                                borderWidth: 1,
            ...
            {/* 2. Action Thumbnail (Start Match) */}
            {
                activeClub && (
                    <TouchableOpacity
                    ...
                    >
                        <View style={styles.actionContent}>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <Text style={styles.actionSubtitle}>Record scores and track stats</Text>
                            </View>
                            <Ionicons name="arrow-forward-circle" size={32} color="white" style={{ opacity: 0.9 }} />
                        </View>
                    </TouchableOpacity>
                )
            }
            ...
            <ClubSelectorModal
                ...
                onCreateClub={() => navigation.navigate('CreateClub' as never)}
                onJoinClub={() => navigation.navigate('JoinClub' as never)}
                theme={theme}
            />
                ...
                <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
                    ...
                    {!activeClub ? (
                        ...
                        <View>
                            ...
                            {/* Start Button (Option 3: Pill Style) */}
...
const createStyles = (theme: Theme) => StyleSheet.create({
    ...
    // Removed old greeting/clubPill styles context...
    avatar: {
    ...
    alertTitle: { color: '#744210', fontWeight: 'bold', fontSize: 14, marginBottom: 2 },
    alertText: { color: '#975A16', fontSize: 12 },
    ...
    // headerLeft/Right helper styles no longer needed for new layout but keeping safe just in case
    headerLeft: { flexDirection: 'row', alignItems: 'center', flex: 1 },
    headerRight: { flexDirection: 'row', alignItems: 'center' },

    headerGreeting: { fontSize: 18, color: theme.colors.textPrimary, fontWeight: '700', marginLeft: 12 },
    clubSelectorRow: {
        flex: 1,
        flexDirection: 'row',
        alignItems: 'center',
        justifyContent: 'space-between',
        backgroundColor: theme.colors.primary + '10', // Rich Tint
        borderWidth: 1,
        borderColor: theme.colors.primary + '15',
        paddingVertical: 14, // Taller pill
        paddingHorizontal: 16,
        borderRadius: 16,
    },
    clubSelectorText: { fontSize: 16, fontWeight: '700', color: theme.colors.primary, flex: 1 },


    // -- Action Thumbnail (Start Match) --
    actionThumbnail: {
        marginHorizontal: 16,
        marginTop: 12,
        marginBottom: 16,
    ...
    // gradientBg: { ...StyleSheet.absoluteFillObject }, // Removed
    actionContent: {
        flexDirection: 'row',
        alignItems: 'center',
    ...
    actionIconBox: {
        width: 44, height: 44,
        borderRadius: 14,
        backgroundColor: '#FFFFFF', // High contrast white box
        justifyContent: 'center', alignItems: 'center',
        marginRight: 14,
        // Glow/Shadow
        shadowColor: "#000",
    ...
    actionTitle: { fontSize: 16, fontWeight: '800', color: 'white', letterSpacing: 0.5 }, // Reduced font size
    actionSubtitle: { fontSize: 11, color: 'rgba(255,255,255,0.9)', marginTop: 0 }, // Reduced font size and margin
    ...
    heroTitle: {
        fontSize: 20, fontWeight: '800', color: 'white', letterSpacing: 0.5, marginBottom: 2
    },
    heroSubtitle: {
        fontSize: 12, fontWeight: '500', color: 'rgba(255,255,255,0.9)'
    },
    heroCircle1: {
        position: 'absolute', top: -30, right: -20, width: 100, height: 100, borderRadius: 50, backgroundColor: 'rgba(255,255,255,0.1)'
    },
    heroCircle2: {
        position: 'absolute', bottom: -40, left: 10, width: 140, height: 140, borderRadius: 70, backgroundColor: 'rgba(255,255,255,0.05)'
    },
